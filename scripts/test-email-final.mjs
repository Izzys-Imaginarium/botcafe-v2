// Email test script that properly loads environment variables
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <p style="color: #666; font-size: 12px;">
            This email was sent from BotCafe application to test the Resend integration.<br>
...
const success = await testResendEmail()
