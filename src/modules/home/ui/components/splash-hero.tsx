  ...
  return (
    <main className="flex-grow flex flex-col items-center justify-center text-center px-4 relative z-10 pt-32 sm:pt-24 min-h-screen">
      ...
      <div className="max-w-5xl w-full flex flex-col items-center justify-center relative mt-4 md:mt-0">
        ...
        {/* Main title */}
        <h1 className="font-display font-bold text-5xl sm:text-7xl md:text-8xl lg:text-9xl mb-6 text-transparent bg-clip-text bg-gradient-to-br from-gold-rich via-parchment to-gold-ancient tracking-tight drop-shadow-lg pb-4 px-4 relative leading-[1.2] sm:leading-tight">
          BotCafé
